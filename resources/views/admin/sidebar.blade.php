  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{route('admin.jobs')}}" class="nav-link {{ Route ::is('admin.jobs','admin.jobs*') ? 'active': ''}}">
        ...
        <li class="nav-item">
          <a href="{{route('admin.profile')}}" class="nav-link {{ Route::is('admin.profile','admin.profile.*') ? 'active' : ''}}">
